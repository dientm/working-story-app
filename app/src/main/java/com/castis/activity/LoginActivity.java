 ...
 */
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor>, RequestService.AsyncResponse{
...
//            JSONObject responseJson = new JSONObject(response);
     ...
     * the user.
     */
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> implements RequestService.AsyncResponse{
